  ...
  return (
    <div>
      ...
      {/* <Helmet>
        ...
        <meta
          property="og:image"
          content="https://www.kodeend.com/static/media/erp2.78f269fbf6920e10d3fa.jpg"
        />
        <meta
          property="og:url"
        ...
        <div className="another-card">
          ...
          <div>
            ...
            <Typography className="text-left font-regular my-5">
              A well-designed and efficient website is necessary for businesses
              to develop an online presence, draw clients, and promote success
              in the digital age. As a top supplier of innovative technology
              remedies, Kodeend IT Solutions specializes in website creation,
              producing outstanding websites that attract audiences and satisfy
              a variety of corporate demands.
            </Typography>
          </div>
          ...
          <div>
            ...
            <Typography className="text-left font-regular my-5">
              ...
              needs. Kodeend IT Solutions makes sure that every component of the
              website is customized to match the unique demands of the business
              through a thorough research process and diligent planning,
              creating a highly individualized online presence.
            </Typography>
          </div>
          <div>
            <Typography
            ...
            <Typography className="text-left font-regular my-5">
              People view websites using a variety of devices, Kodeend Solutions
              places a high priority on responsive design to provide the best
              possible user experience. Their method of web creation guarantees
              that websites look good, are simple to use, and work properly on
              desktops, laptops, tablets, and mobile devices. Kodeend makes sure
              that businesses can successfully engage with their target audience
              regardless of the device they use by using responsive design
              concepts.
            </Typography>
          </div>
          <div>
          ...
          <div>
            ...
            <Typography className="text-left font-regular my-5">
              When developing websites, Kodeend IT Solutions takes a futuristic
              stance, taking into account scalability and potential future
              demands. Their websites were created with adaptability in mind,
              making it simple to expand and change as the company expands.
              Kodeend guarantees that websites can handle rising traffic,
              implement new features, and smoothly interface with expanding
              digital ecosystems by utilizing powerful and scalable
              technologies.
            </Typography>
          </div>
          <div>
            <Typography
              ...
              className="mb-2 font-bold lg:text-xl lg:mb-5 text-black"
            >
              Enhancing Website Performance Through Integration and Optimization
            </Typography>
            <Typography className="text-left font-regular my-5">
