...
export default function TermsAndConditions() {
  return (
    <div>
      <h1 className="service-text-2 font-bold">TERMS AND CONDITIONS</h1>
      <Card className="mx-auto w-11/12 lg:w-3/4 p-1 lg:p-10 my-5 lg:my-20">
        <CardBody>
          <Typography
            variant="h2"
            color="blue-gray"
          ...
          <Typography className="font-regular text-lg">
          ...
          <Typography className="font-regular text-lg">
            ...
            <span>
              <br /> <br /> 1. Affiliate means an entity that controls, is
              controlled by or is under common control with a party, where
              "control" means ownership of 50% or more of the shares, equity
              interest or other securities entitled to vote for election of
              directors or other managing authority.
              <br /> <br /> 2. Country refers to: Sweden
              <br /> <br /> 3. Company (referred to as either "the Company",
              "We", "Us" or "Our" in this Agreement) refers to KodeEnd IT
              Solutions AB, Räfsgatan 36, 216 33 Limhamn, Sweden.
              <br /> <br /> 4. Device means any device that can access the
              Service such as a computer, a cellphone or a digital tablet.
              <br /> <br /> 5. Service refers to the Website.
              <br /> <br /> 6. Terms and Conditions (also referred as "Terms")
              ...
              <br /> <br /> 7. Third-party Social Media Service means any
              services or content (including data, information, products or
              services) provided by a third-party that may be displayed,
              included or made available by the Service
              <br /> <br /> 8. Website refers to kodeend, accessible from
              www.kodeend.com.
              <br /> <br /> 9. You means the individual accessing or using the
          ...
          <Typography className="font-regular text-lg">
            ...
            <br /> <br /> Your access to and use of the Service is conditioned
            ...
            <br /> <br /> By accessing or using the Service You agree to be
            ...
            <br /> <br /> You represent that you are over the age of 18. The
            Company does not permit those under 18 to use the Service.
            <br /> <br /> Your access to and use of the Service is also
            ...
            read Our Privacy Policy carefully before using Our Service. <br />{" "}
            <br />
          </Typography>
          <Typography
            variant="h2"
          ...
          <Typography className="font-regular text-lg">
            ...
            <br /> <br /> The Company has no control over, and assumes no
          ...
          <Typography className="font-regular text-lg">
            ...
            through the Service.
            <br /> <br /> To the maximum extent permitted by applicable law, in
            ...
            <br /> <br /> Some states do not allow the exclusion of implied
          ...
          <Typography className="font-regular text-lg">
            ...
            <br /> <br /> By continuing to access or use Our Service after those
          ...
          <Typography className="font-regular text-lg">
            ...
            contact us:
            <br /> <br /> By email: info@kodeend.com
            <br /> <br /> By visiting this page on our website www.kodeend.com.
            <br /> <br /> By phone number: 0046 708698276
            <br /> <br />
          </Typography>
        </CardBody>
      </Card>
