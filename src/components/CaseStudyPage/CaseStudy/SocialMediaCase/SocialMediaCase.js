...
import img from "../../../../assets/images/case-study/4.png";
      ...
      <Card className="flex-col md:flex-row case-card ">
        ...
        <div>
          <CardBody className="card-body keep-scrolling py-0">
            <Typography className=" text-lg text-center lg:text-justify lg:text-2xl sticky top-0  mt-10  md:mt-0 bg-white  font-bold text-blue-600">
              Unsupervised Sentiment Analysis: Extracting Insights from Social
              Media Data for Brand Reputation Management
            </Typography>
            {allData.map((data) => {
              return (
                <div>
