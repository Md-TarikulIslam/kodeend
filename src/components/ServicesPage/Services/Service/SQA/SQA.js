...
import img from "../../../../../assets/images/services/service/sqa/main.jpg";
    ...
    <div>
      <div>
        <h1 className="service-text-2 font-bold">
          SQA SERVICES OF THE HIGHEST QUALITY FOR OUTSTANDING <br /> SOFTWARE
          PRODUCTS
        </h1>
      </div>
      ...
      <div className=" flex ">
        <div className="single-service-card  flex lg:flex-row flex-col items-center mx-auto">
          ...
          <div className="single-service-text">
            Software quality assurance (SQA) is an important stage in the
      ...
      <QuoteForm></QuoteForm>
      <div>
        <h1 className="why-choose-text ">WHY CHOOSE OUR SQA SERVICES</h1>
